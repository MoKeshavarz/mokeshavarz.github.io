...
export const metadata: Metadata = { title: "Projects", description: "Engineering project and case-study records focused on decisions, integrations, outcomes, and lessons." };
